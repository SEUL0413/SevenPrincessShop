...
<body>
	...
	<form>
		...
		<div style="border:1px solid black; position:absolute;right:150px;top:100px">			
			...
			<input type="button" onclick="location.href='updateStatus?idxs=all'" value="전체상품 주문하기"/>
			<!-- 선택된 주문idx(내가 넘겨주는 값)=> vo 하나씩 select해서 arrayList에 담아서 뿌리고 결제 진행 -->
			<button type="button" onclick="selectOrder(this.value)" value="1">선택상품 주문하기</button>
		</div>
	</form>
</body>
</html>